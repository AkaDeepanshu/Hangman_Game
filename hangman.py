...
# game variables
hangman_status = 0
words = ["DEVELOPER", "HELLO", "ENGINEER", "PYTHON", "CLASS", "STRUCTURE"]
...
def draw():
    ...
    win.blit(images[hangman_status],(130,85))
...
def display_message(message):
    ...
    win.blit(text, (WIDTH/2 - text.get_width()/2, HEIGHT/2.5 - text.get_height()/2))
